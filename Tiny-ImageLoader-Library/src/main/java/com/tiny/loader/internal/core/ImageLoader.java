...
import com.tiny.loader.internal.cache.disc.DiskCache;
import com.tiny.loader.internal.cache.memory.MemoryCache;
import com.tiny.loader.internal.core.assist.FailReason;
import com.tiny.loader.internal.core.assist.FlushedInputStream;
import com.tiny.loader.internal.core.assist.ImageSize;
import com.tiny.loader.internal.core.assist.LoadedFrom;
import com.tiny.loader.internal.core.assist.ViewScaleType;
import com.tiny.loader.internal.core.imageaware.ImageAware;
import com.tiny.loader.internal.core.imageaware.ImageViewAware;
import com.tiny.loader.internal.core.imageaware.NonViewAware;
...
import com.tiny.loader.internal.core.listener.SimpleImageLoadingListener;
import com.tiny.loader.internal.utils.ImageSizeUtils;
...
public class ImageLoader {
    ...
    static final String LOG_INIT_CONFIG = "Initialize TinyImageLoader with configuration";
    static final String LOG_DESTROY = "Destroy TinyImageLoader";
    static final String LOG_LOAD_IMAGE_FROM_MEMORY_CACHE = "Load image from memory cache [%s]";

    private static final String WARNING_RE_INIT_CONFIG = "Try to initialize TinyImageLoader which had already been initialized before. " + "To re-init TinyImageLoader with new configuration call TinyImageLoader.destroy() at first.";
    private static final String ERROR_WRONG_ARGUMENTS = "Wrong arguments were passed to displayImage() method (ImageView reference must not be null)";
    private static final String ERROR_NOT_INIT = "TinyImageLoader must be init with configuration before using";
    private static final String ERROR_INIT_CONFIG_WITH_NULL = "TinyImageLoader configuration can not be initialized with null";
    ...
    /**
     * Initializes TinyImageLoader instance with configuration.<br />
     * If configurations was set before ( {@link #isInited()} == true) then this method does nothing.<br />
     * To force initialization with new configuration you should {@linkplain #destroy() destroy TinyImageLoader} at first.
     *
     * @param configuration {@linkplain ImageLoaderConfiguration TinyImageLoader configuration}
    ...
    /**
     * Returns <b>true</b> - if TinyImageLoader {@linkplain #init(ImageLoaderConfiguration) is initialized with
     ...
     * @param imageAware {@linkplain com.tiny.loader.internal.core.imageaware.ImageAware Image aware view}
     ...
     * @param imageAware {@linkplain com.tiny.loader.internal.core.imageaware.ImageAware Image aware view}
     *                   which should display image
     * @param options    {@linkplain com.tiny.loader.internal.core.DisplayImageOptions Options} for image
     ...
     * @param progressListener {@linkplain com.tiny.loader.internal.core.listener.ImageLoadingProgressListener
     *                         Listener} for image loading progress. Listener fires events on UI thread if this method
     *                         is called on UI thread. Caching on disk should be enabled in
     *                         {@linkplain com.tiny.loader.internal.core.DisplayImageOptions options} to make
     *                         this listener work.
     * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
     * @throws IllegalArgumentException if passed <b>imageAware</b> is null
     */
     ...
     * {@link com.tiny.loader.internal.core.imageaware.ImageAware ImageAware}
     */
     ...
     * {@link com.tiny.loader.internal.core.imageaware.ImageAware ImageAware}.
     *
     * @param imageAware {@link com.tiny.loader.internal.core.imageaware.ImageAware ImageAware} for
    ...
    /**
     * Denies or allows TinyImageLoader to download images from the network.<br />
     * <br />
    ...
    /**
     * Sets option whether TinyImageLoader will use {@link FlushedInputStream} for network downloads to handle <a
    ...
    /**
     * Pause TinyImageLoader. All new "load&display" tasks won't be executed until TinyImageLoader is {@link #resume() resumed}.
     * <br />
     ...
     * {@linkplain com.tiny.loader.internal.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
     * custom task executors} if you set them.<br />
     * TinyImageLoader still can be used after calling this method.
     */
    public void stop() {
        if (null != engine) {
            engine.stop();
    ...
    /**
     * {@linkplain #stop() Stops TinyImageLoader} and clears current configuration. <br />
     * You can {@linkplain #init(ImageLoaderConfiguration) init} TinyImageLoader with new configuration after calling this
     * method.
     */
    public void destroy() {
        stop();
