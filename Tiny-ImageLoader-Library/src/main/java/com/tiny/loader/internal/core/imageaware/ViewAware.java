...
public abstract class ViewAware implements ImageAware {
    ...
    public static final String WARN_CANT_SET_DRAWABLE = "Can't set a drawable into view. You should call TinyImageLoader on UI thread for it.";
    public static final String WARN_CANT_SET_BITMAP = "Can't set a bitmap into view. You should call TinyImageLoader on UI thread for it.";
