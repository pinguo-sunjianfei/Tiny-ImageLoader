 ...
 *******************************************************************************/
package com.tiny.loader.internal.core.decode;
...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain com.tiny.loader.internal.utils.MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache). */
	...
	/** @return The original image URI which was passed to TinyImageLoader */
