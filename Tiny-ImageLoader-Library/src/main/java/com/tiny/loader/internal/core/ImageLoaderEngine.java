...
class ImageLoaderEngine {
    ...
    void submit(final LoadAndDisplayImageTask task) {
        taskExecutor.execute(new Runnable() {
            @Override
            public void run() {
                File image = configuration.diskCache.get(task.getMemoryCacheKey());
    ...
    /**
     * Returns URI of image which is loading at this moment into passed {@link com.tiny.loader.internal.core.imageaware.ImageAware}
     */
     ...
     *
     * @param imageAware {@link com.tiny.loader.internal.core.imageaware.ImageAware} for which display task
     *                   will be cancelled
     */
    ...
    /**
     * Pauses engine. All new "load&display" tasks won't be executed until TinyImageLoader is {@link #resume() resumed}.<br
