...
import com.tiny.loader.internal.cache.disc.naming.FileNameGenerator;
import com.tiny.loader.internal.cache.memory.MemoryCache;
import com.tiny.loader.internal.cache.memory.impl.FuzzyKeyMemoryCache;
...
import com.tiny.loader.internal.core.decode.ImageDecoder;
import com.tiny.loader.internal.core.download.ImageDownloader;
import com.tiny.loader.internal.core.process.BitmapProcessor;
import com.tiny.loader.internal.utils.L;
import com.tiny.loader.internal.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
     ...
     * <li>diskCache = {@link com.tiny.loader.internal.cache.disc.impl.UnlimitedDiskCache}</li>
    ...
    public static class Builder {
        ...
        /**
         * @deprecated Use
         * {@link #diskCacheExtraOptions(int, int, com.tiny.loader.internal.core.process.BitmapProcessor)}
         * instead
         */
        @Deprecated
         ...
         * <b>NOTE: Use this option only when you have appropriate needs. It can make TinyImageLoader slower.</b>
         *
         ...
         * {@link com.tiny.loader.internal.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
         ...
         * Default value - {@link com.tiny.loader.internal.cache.memory.impl.LruMemoryCache LruMemoryCache}
         ...
         * <b>NOTE:</b> If you use this method then
         * {@link com.tiny.loader.internal.cache.disc.impl.ext.LruDiskCache LruDiskCache}
        ...
        /**
         * @deprecated Use {@link #diskCache(com.tiny.loader.internal.cache.disc.DiskCache)}
         */
        @Deprecated
         ...
         * Default value - {@link com.tiny.loader.internal.cache.disc.impl.UnlimitedDiskCache
         * UnlimitedDiskCache}. Cache directory is defined by
         * {@link com.tiny.loader.internal.utils.StorageUtils#getCacheDirectory(Context)
         ...
         * Default value -
         * {@link com.tiny.loader.internal.core.DefaultConfigurationFactory#createImageDownloader(Context)
         ...
         * Default value -
         * {@link com.tiny.loader.internal.core.DefaultConfigurationFactory#createImageDecoder(boolean)
         ...
         * Consider {@link com.tiny.loader.internal.utils.L#disableLogging()} to disable
         * TinyImageLoader logging completely (even error logs)
         */
        ...
        private void initEmptyFieldsWithDefaultValues() {
            ...
            if (diskCache == null) {
                diskCache = DefaultConfigurationFactory
                        .createDiskCache(context, diskCacheSize, diskCacheFileCount);
            }
            if (memoryCache == null) {
     ...
     * using {@link com.tiny.loader.internal.core.assist.FlushedInputStream}.
     *
     * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
     * @since 1.8.1
     */
    ...
    public void setMaxImageWidthForDiskCache(int maxImageWidthForDiskCache) {
        this.maxImageWidthForDiskCache = maxImageWidthForDiskCache;
    }
    ...
    public void setMaxImageHeightForDiskCache(int maxImageHeightForDiskCache) {
        this.maxImageHeightForDiskCache = maxImageHeightForDiskCache;
    }
}