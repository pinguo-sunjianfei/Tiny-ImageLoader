...
import com.tiny.loader.core.cache.CustomDiskCache;
import com.tiny.loader.core.display.BlurBitmapDisplayer;
import com.tiny.loader.core.display.BlurFadeInBitmapDisplayer;
import com.tiny.loader.core.display.CircleBitmapDisplayer;
import com.tiny.loader.core.display.CircleBlurBitmapDisplayer;
import com.tiny.loader.core.display.CircleFadeInBitmapDisplayer;
import com.tiny.loader.core.display.CircleRingBitmapDisplayer;
import com.tiny.loader.core.display.PolygonBitmapDisplayer;
import com.tiny.loader.core.display.RoundedBitmapDisplayer;
import com.tiny.loader.core.display.RoundedBlurBitmapDisplayer;
import com.tiny.loader.core.display.RoundedFadeInBitmapDisplayer;
import com.tiny.loader.core.display.RoundedLomoBitmapDisplayer;
import com.tiny.loader.core.display.RoundedLomoBlurBitmapDisplayer;
import com.tiny.loader.core.display.RoundedLomoFadeInBitmapDisplayer;
import com.tiny.loader.core.imageaware.ImageSwitcherAware;
import com.tiny.loader.core.imageaware.SimpleViewAware;
import com.tiny.loader.core.util.NameGeneratorUtil;
import com.tiny.loader.internal.cache.disc.DiskCache;
import com.tiny.loader.internal.cache.disc.impl.UnlimitedDiskCache;
import com.tiny.loader.internal.cache.memory.MemoryCache;
import com.tiny.loader.internal.cache.memory.impl.LruMemoryCache;
import com.tiny.loader.internal.core.DisplayImageOptions;
import com.tiny.loader.internal.core.ImageLoaderConfiguration;
...
import com.tiny.loader.internal.core.decode.BaseImageDecoder;
import com.tiny.loader.internal.core.display.FadeInBitmapDisplayer;
import com.tiny.loader.internal.core.display.SimpleBitmapDisplayer;
import com.tiny.loader.internal.core.download.BaseImageDownloader;
...
import com.tiny.loader.internal.utils.StorageUtils;
...
public class TinyImageLoader {
    ...
    private static com.tiny.loader.internal.core.ImageLoader mImageLoader;
    ...
    public static synchronized void init(Context context, String cacheDir, long diskCacheSize) {
        mContext = context;
        mImageLoader = com.tiny.loader.internal.core.ImageLoader.getInstance();
    ...
    public static class Builder {
        ...
        public void load() {
            ...
            TinyImageLoader.load(this.mUrl, this.mImageSize, this.build(), this.mImageLoadingListener,
        ...
        public void into(View view) {
            ...
            TinyImageLoader.display(this.mUrl, view, this.build(),
